...
@section('title', 'Practice Session - ' . $certification->name)

@section('content')
<!-- Back Button -->
<div class="mb-3">
    <a href="{{ route('learner.certifications.show', $certification->id) }}" class="btn btn-sm btn-outline-secondary">
        <i class="bi bi-arrow-left me-1"></i> Back to Certification
    </a>
</div>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <p class="mb-0">
            ...
            Choose a practice mode below to start improving your knowledge and skills.
        </p>
    </div>
</div>
