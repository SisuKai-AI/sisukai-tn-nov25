...
@section('title', 'Create Exam Session')

@section('content')
<div class="container-fluid">
    <!-- Page Header -->
    <div class="mb-4">
        <h1 class="h3 mb-0">Create Exam Session</h1>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.exam-sessions.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select name="certification_id" id="certification_id" class="form-select @error('certification_id') is-invalid @enderror" required>
                                ...
                                @foreach($certifications as $cert)
                                    <option value="{{ $cert->id }}" {{ old('certification_id') == $cert->id ? 'selected' : '' }}>
                                        {{ $cert->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="exam_type" id="type_benchmark" value="benchmark" {{ old('exam_type', 'final') == 'benchmark' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="exam_type" id="type_practice" value="practice" {{ old('exam_type') == 'practice' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="exam_type" id="type_final" value="final" {{ old('exam_type', 'final') == 'final' ? 'checked' : '' }} checked>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="total_questions" id="total_questions" class="form-control @error('total_questions') is-invalid @enderror" 
                                       value="{{ old('total_questions', 50) }}" min="5" max="200" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="time_limit_minutes" id="time_limit_minutes" class="form-control @error('time_limit_minutes') is-invalid @enderror" 
                                       value="{{ old('time_limit_minutes') }}" min="5" max="300">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="difficulty_level" id="difficulty_level" class="form-select @error('difficulty_level') is-invalid @enderror">
                                    ...
                                    <option value="mixed" {{ old('difficulty_level') == 'mixed' ? 'selected' : '' }}>Mixed</option>
                                </select>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="adaptive_mode" id="adaptive_mode" value="1" {{ old('adaptive_mode') ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle me-2"></i>Create Exam Session
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <ul class="small mb-0">
                        <li class="mb-2">Benchmark exams typically have 30-50 questions</li>
                        <li class="mb-2">Practice exams work best with 10-30 questions</li>
                        <li class="mb-2">Final exams should match the actual certification format</li>
                        <li>Enable adaptive mode for practice exams to personalize difficulty</li>
                    </ul>
                </div>
            </div>
        </div>
