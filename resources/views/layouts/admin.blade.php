...
<head>
    ...
    <title>@yield('title', 'Dashboard') - SisuKai Admin</title>
    ...
    <style>
        ...
        .user-avatar {
            ...
            height: 38px;
            border-radius: 50%;
            background: linear-gradient(135deg, var(--danger-color) 0%, #ff6838 100%);
            display: flex;
            align-items: center;
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            <h4>SisuKai <span class="badge bg-danger">Admin</span></h4>
        </div>
        ...
        <nav class="sidebar-menu">
            ...
            <div class="menu-item">
                <a href="{{ route('admin.learners.index') }}" class="menu-link {{ request()->routeIs('admin.learners.*') ? 'active' : '' }}">
            ...
            <div class="menu-item">
                <a href="{{ route('admin.certifications.index') }}" class="menu-link {{ request()->routeIs('admin.certifications.*') ? 'active' : '' }}">
            ...
            <div class="menu-item">
                <a href="{{ route('admin.questions.index') }}" class="menu-link {{ request()->routeIs('admin.questions.*') ? 'active' : '' }}">
            ...
            <div class="menu-item">
                <a href="{{ route('admin.exam-sessions.index') }}" class="menu-link {{ request()->routeIs('admin.exam-sessions.*') ? 'active' : '' }}">
                    <i class="bi bi-clipboard-check menu-icon"></i>
                    <span>Exam Sessions</span>
                </a>
            </div>
            
            <div class="menu-header">LANDING PORTAL</div>
            ...
            <div class="menu-item">
                <a href="{{ route('admin.legal-pages.index') }}" class="menu-link {{ request()->routeIs('admin.legal-pages.*') ? 'active' : '' }}">
            ...
            <div class="menu-item">
                <a href="{{ route('admin.blog-categories.index') }}" class="menu-link {{ request()->routeIs('admin.blog-categories.*') ? 'active' : '' }}">
            ...
            <div class="menu-item">
                <a href="{{ route('admin.newsletter-subscribers.index') }}" class="menu-link {{ request()->routeIs('admin.newsletter-subscribers.*') ? 'active' : '' }}">
